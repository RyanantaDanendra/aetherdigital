...
export default function Why() {
  return (
    <div className="why-container w-full hscreen">
      <h1 className="text-center text text-6xl font-bold">WHY CHOOSE US?</h1>
      <div className="why-content-container grid grid-cols-3 mt-12">
        <div className="flex flex-col items-center gap-5">
          <div className="card lg:w-80 lg:h-60 bg-transparent border-4 border-[#D4AF37] rounded-2xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="w-10 mx-auto mt-3"
            >
            ...
            <h1 className="mt-6 text-center font-bold">TRUSTED</h1>
            <p className="text-lg mt-6 ms-2">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="card lg:w-80 lg:h-60 bg-transparent border-4 border-[#D4AF37] rounded-2xl">
            ...
            <h1 className="mt-6 text-center font-bold text-xl">AFFORDABLE</h1>
            <p className="text-lg mt-6 ms-2">

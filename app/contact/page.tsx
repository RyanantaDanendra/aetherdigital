...
export default function Contact() {
  return (
    <div className="contact-container bg-[#2F2F2F] text-white w-screen min-h-screen grid grid-cols-2 px-20 pb-8">
      <div className="col-span-1 flex flex-col justify-between pt-38">
        <div className="contact-information-container">
          ...
          <div className="flex items-center gap-5 mt-8">
            ...
            <p className="text-2xl">Denpasar, Bali</p>
          </div>
          <div className="flex items-center gap-5 mt-5">
            ...
            <p className="text-2xl">aetherdigital@gmail.com</p>
          </div>
          <div className="flex items-center gap-5 mt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-2xl">+62 1234567890</p>
          </div>
        </div>
        <div>
      ...
      <div className="col-span-1 place-self-center">
        <div className="map-container w-150 h-150 mt-10">
          <Map />
        </div>
      </div>
    </div>
